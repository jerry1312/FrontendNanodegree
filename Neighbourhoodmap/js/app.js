  ...
  self.addApiInfo = function (counter_marker) {
    $.ajax({
      ...
      success: function (data) {
        ...
        counter_marker.twitter = out.contact.hasOwnProperty('twitter') ? out.contact.twitter : "Not Available";
        counter_marker.phone = out.contact.hasOwnProperty('phone') ? out.contact.phone : "Not Available";
      
        infowindow.setContent('<div id="placeinfo">' + '<h4>'+counter_marker.placename+'</h4>' + '<h5>'+'No. Of Likes: ' +
          counter_marker.likes + '</br></br>Ratings: ' +
          counter_marker.rating+'</br>Twitter: '+counter_marker.twitter+'</br>Phone: '+counter_marker.phone+'</h5>'+'</div>' );
